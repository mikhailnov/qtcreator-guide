...
\usepackage[cache=false]{minted} % Оформление исходного кода, https://github.com/gpoore/minted/issues/92
\setminted{fontsize=\small} % Уменьшение размера кода, иначе по ширине не влезает
...
\hypersetup{
    ...
    pdfauthor={Михаил Новоселов},
    pdftitle={Руководство по Qt Creator}
}
...
\newcommand{\addimg}[4]{ % Добавление одного рисунка
    \begin{figure}
        \centering
        \includegraphics[scale=1,width=#2\linewidth]{#1}
        \caption{#3} \label{#4}
    \end{figure}
}
